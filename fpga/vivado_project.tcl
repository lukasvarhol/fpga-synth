...
set_property -name "customized_default_ip_location" -value "C:/Users/Lukas Varhol/Documents/Code/fpga-synth/fpga/ips" -objects $obj
...
set file "$origin_dir/src/phase_accumulator.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/src/sample_rate_tick_driver.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
